...
const actionButtonPt = computed(() => ({
  ...
  icon: {
    ...
    style: isLarge.value
      ? 'width:25px !important;min-width:25px !important;height:25px !important;min-height:25px !important;font-size:25px !important;line-height:25px !important;margin:0 !important;overflow:visible !important;color:#001f2f !important;'
